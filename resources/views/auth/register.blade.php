                ...
                <div class="card card-signup text-center">
                    <div class="card-header ">
                        ...
                        <div class="social">
                            ...
                            <h5 class="card-description"> {{ __('o al estilo clásico') }}</h5>
                        </div>
                    </div>
                    <div class="card-body ">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}"
                                    placeholder="{{ __('Nombre') }}" type="text" name="name" value="{{ old('name') }}"
                                    required autofocus>
                                @if ($errors->has('name'))
                            ...
                            <div class="input-group {{ $errors->has('lastName') ? ' has-danger' : '' }}">
                                    ...
                                    <input class="form-control {{ $errors->has('lastName') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('Apellido') }}" type="text" name="lastName" value="{{ old('lastName') }}"
                                        required>
                            ...
                            <div class="card-footer ">
                                <button type="submit"
                                    class="btn btn-primary btn-round btn-lg">{{__('Crear cuenta')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
