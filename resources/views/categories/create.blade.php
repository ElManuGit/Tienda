                        ...
                        <form method="post" action="{{ route('categories.store') }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description" id="input-description" class="form-control{{ $errors->has('text') ? ' is-invalid' : '' }}" placeholder="{{ __('Descripción') }}" value="{{ old('description') }}"></textarea>
